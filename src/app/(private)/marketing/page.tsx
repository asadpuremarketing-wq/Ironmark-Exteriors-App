...
import { serializeMarketingSpend, getLeadSourcePerformance, getOverallAdCostPerJob } from "@/lib/marketing";
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-ink-900/60">
          Log ad spend and see your real cost per job booked.
        </p>
      </div>

      <MarketingView spend={spend} performance={performance} overall={overall} />
    </div>
  );
}
